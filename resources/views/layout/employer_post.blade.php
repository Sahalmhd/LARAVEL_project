                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Post a job</h4>
...
<form action="javascript:void(0);">
    <div class="row">
        ...
        <div class="col-6">
            <div class="mb-3">
                <label for="lastNameinput" class="form-label">Job role</label>
        ...
        <div class="col-6">
            <div class="mb-3">
                <label for="firstNameinput" class="form-label">QUALIFICATION FOR JOB</label>
                <input type="text" class="form-control" placeholder="Enter your QUALIFICATION" id="firstNameinput">
            </div>
        </div><!--end col-->
        <div class="col-6">
            <div class="mb-3">
                <label for="firstNameinput" class="form-label">EXPERIENCE NEED</label>
        ...
        <div class="mb-3 ">
            ...
            <textarea class="form-control" id="VertimeassageInput" rows="4" placeholder="Enter your message"></textarea>
        </div>
